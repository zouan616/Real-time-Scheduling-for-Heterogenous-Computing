...
def pic2():
    type_1 = ['XDM', 'XDM', 'XDM']
    newMethod = [1.0, 0.8, 0.3]
    newMethod_2 = [0.85, 0.75, 0.6]
    SCAIR_OPA = [0.65, 0.45, 0.15]
    SCAIR_OPA_2 = [1.05, 0.9, 0.65]
    STGM = [0.7, 0.4, 0.01]
    STGM_2 = [1.05, 1.0, 0.49]
    MPCP = [0.01, 0.01, 0.01]
    MPCP_2 = [0.69, 0.59, 0.44]
    XDM = [0.01, 0.01, 0.01]
    XDM_2 = [0.59, 0.01, 0.01]
