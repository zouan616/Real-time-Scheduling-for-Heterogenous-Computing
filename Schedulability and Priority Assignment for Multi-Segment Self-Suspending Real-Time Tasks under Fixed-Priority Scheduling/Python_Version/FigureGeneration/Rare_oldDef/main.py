...
def pic1():
    ...
    plt.savefig('./pic1.png', transparent=True, format='png', dpi=600)
    # plt.show()
...
def pic1_1():
    ...
    ax.set_yticklabels(algorithm_name, fontsize=16)
    plt.savefig('./pic1_1.png', transparent=True, format='png', dpi=600)
    # plt.show()
...
def pic1_2():
    ...
    ax.set_yticklabels(algorithm_name, fontsize=16)
    plt.savefig('./pic1_2.png', transparent=True, format='png', dpi=600)
    # plt.show()
