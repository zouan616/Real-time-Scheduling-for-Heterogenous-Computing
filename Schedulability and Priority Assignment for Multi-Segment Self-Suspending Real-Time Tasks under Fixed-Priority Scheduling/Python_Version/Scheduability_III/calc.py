...
# print("Workload function = ", workload_function(0, 131))
# print("Worst_case response time = ", worst_case_response_time(0))
# print("Worst_case response time = ", worst_case_response_time(1))
# print("Worst_case response time = ", worst_case_response_time(2))
#
# print("Workload function part 0 = ", workload_function_part(0, 0, 131))
# print("Workload function part 1 = ", workload_function_part(0, 1, 131))
# print("l_max = ", find_l_max(0, 1, 131))
# print("s = ", s(0, 3))
